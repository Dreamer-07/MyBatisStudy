...
import pers.dreamer07.dao.EmployeeDaoAnno;
...
public class EmployeeDaoTest {
    ...
    public void testAnno(){
         ...
         */
            sqlSession = sqlSessionFactory.openSession(true);
            //2. 获取对应的 Dao 实现类
            EmployeeDaoAnno employeeDaoAnno = sqlSession.getMapper(EmployeeDaoAnno.class);
            //3. 执行方法
            Employee employee = employeeDaoAnno.getEmpById(1);
            System.out.println(employee);
        } finally {
            //4. 关闭连接
            if (sqlSession != null) {
